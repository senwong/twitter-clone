...
const Item = styled.div`
  ...
  background-color: ${props =>
    props.selected ? "rgb(245, 248, 250)" : "transparent"};
`;
...
function SearchHistorys({ selected, deleteHistory, deleteAll }) {
  ...
  const [historys, setHistorys] = useState(getSearchHistory());
  useEffect(() => {
