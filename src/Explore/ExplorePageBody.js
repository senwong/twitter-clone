...
function ExplorePageBody() {
  ...
  useEffect(() => {
    ...
    getNewEventsPromise.promise.then(
      res => setNewEvents(res.data),
    );
    return () => {
  ...
  useEffect(() => {
    ...
    getRecommendUsersPromise.promise.then(
      res => setRecommenders(res.data),
    );
    return () => {
  ...
  useEffect(() => {
    ...
    getPopularArticlesPromise.promise.then(
      res => setPopularArticles(res.data),
    );
    return () => {
