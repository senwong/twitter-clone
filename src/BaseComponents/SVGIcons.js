...
export function BackIcon(props) {
  return (
    <SvgWrapper {...props}>
      <Svg viewBox="0 0 24 24"><g><path d="M20 11H7.414l4.293-4.293a1 1 0 0 0-1.414-1.414l-6 6a1 1 0 0 0 0 1.414l6 6a.996.996 0 0 0 1.414 0 1 1 0 0 0 0-1.414L7.414 13H20a1 1 0 1 0 0-2z" /></g></Svg>
    </SvgWrapper>
  );
}
...
export function PullDownIcon(props) {
  return (
    <SvgWrapper {...props}>
      <Svg aria-label="下拉刷新" viewBox="0 0 30 72"><g><path d="M28.414 38.586a2.001 2.001 0 0 0-2.828 0L17 47.172V22c0-1.106-.894-2-2-2s-2 .894-2 2v25.172l-8.586-8.586a2 2 0 1 0-2.828 2.828l12 12c.39.39.9.586 1.414.586s1.024-.196 1.414-.586l12-12c.78-.78.78-2.046 0-2.828z" /></g></Svg>
    </SvgWrapper>
  );
}
  ...
  return (
    <WattingIconWrapper {...props}>
      <Svg viewBox="0 0 32 32">
        ...
        <circle cx="16" cy="16" fill="none" r="14" strokeWidth="4" style={{ stroke: 'rgb(29, 161, 242)', strokeDasharray: 80, strokedashoffset: 60 }} />
      </Svg>
    </WattingIconWrapper>
  );
}
...
export function PurpleStar(props) {
  return (
    <SvgWrapper {...props}>
      <Svg viewBox="0 0 24 24"><g><path fill="#794BC4" d="M22.99 11.295l-6.986-2.13-.877-.326-.325-.88L12.67.975a.72.72 0 0 0-1.376 0l-2.392 7.84-1.774.657-6.148 1.82a.72.72 0 0 0 0 1.38l7.956 2.358 2.356 7.956a.719.719 0 1 0 1.38.001l1.822-6.15.656-1.773 7.84-2.392a.72.72 0 0 0 0-1.375z" /></g></Svg>
    </SvgWrapper>
  );
}
...
export function ArrowDown(props) {
  return (
    <SvgWrapper {...props}>
      <Svg viewBox="0 0 24 24"><g><path d="M20.207 8.147a1 1 0 0 0-1.414 0L12 14.94 5.207 8.147a1 1 0 0 0-1.414 1.414l7.5 7.5a.996.996 0 0 0 1.414.001l7.5-7.5a1 1 0 0 0 0-1.413z" /></g></Svg>
    </SvgWrapper>
  );
}
...
export function ArrowRight(props) {
  return (
    <SvgWrapper {...props}>
      <Svg viewBox="0 0 24 24"><g><path d="M17.207 11.293l-7.5-7.5a1 1 0 0 0-1.414 1.414L15.086 12l-6.793 6.793a1 1 0 0 0 1.414 1.414l7.5-7.5a1 1 0 0 0 0-1.414z" /></g></Svg>
    </SvgWrapper>
  );
}
...
export function CheckedIcon(props) {
  return (
    <SvgWrapper {...props}>
      <Svg viewBox="0 0 24 24"><g><path d="M9 20a.995.995 0 0 1-.707-.293l-4.785-4.785a1 1 0 0 1 1.414-1.414l3.946 3.945L18.075 4.41a1 1 0 1 1 1.635 1.154L9.817 19.577A1.003 1.003 0 0 1 9 20z" /></g></Svg>
    </SvgWrapper>
  );
}
