      ...
      list: [
        {
          ...
          title: "保护你的推文",
          subTitle:
            "只向关注你的人显示你的推文。选中后，你将需要批准每个新关注者。"
        },
        {
          key: 2,
          type: "link",
      ...
      list: [
        {
          ...
          title: "接收任何人的私信",
          subTitle:
            "你将能接收来自 Twitter 上任何人的私信，即使你没有关注他们。"
        },
        {
          key: 2,
          type: "checkbox",
          title: "显示已读回执",
          subTitle:
            "当有人向你发私信时，对话中的人就会知道你何时已读。若关闭此设置，你将无法看到来自他人的已读回执。"
        }
      ]
    },
    {
...
function Safety({ user }) {
  return (
    <LayOut
      ...
      rightAside={<MakeSettingPanel data={data(user)} />}
    />
  );
}
Safety.propTypes = {
